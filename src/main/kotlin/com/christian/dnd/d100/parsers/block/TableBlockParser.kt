...
abstract class TableBlockParser(
    ...
    abstract fun parse(contents: List<String>, filename: String): List<Table.DirtyTable>
    ...
    protected fun parseTable(tableHeader: TableHeader, tableContents: TableResults): Table.DirtyTable {
